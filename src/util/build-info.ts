...
const time = document.querySelector('meta[name="BUILD_TIME"]') as HTMLMetaElement | null;
const version = document.querySelector('meta[name="BUILD_VERSION"]') as HTMLMetaElement | null;
